...
for f in os.listdir(data_directory):
	...
	u = np.loadtxt(data_directory + "/" + f, delimiter=",")[-1, 1:][0::3].reshape((-1, 1))
...
# Plot the results
plt.scatter(pull_force_kes.keys(), pull_force_kes.values(), c="#ff7f0e", s=100, marker="*", label="dismech", zorder=1)
