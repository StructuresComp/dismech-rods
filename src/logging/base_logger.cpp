 ...
 * class BaseLogger, mostly related to setup.
 *
...
int BaseLogger::countLinesInLog() {
...
std::string BaseLogger::getTimestamp() {
...
std::string BaseLogger::getTimeDateFolderPath() {
