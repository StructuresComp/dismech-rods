/*
 * Some compilers use filesystem while other (older ones) use experimental file
 * system. This is just some checks to determine which one is available on your
 * machine to include.
 *
 * SOURCE:
...
// If the macro isn't defined yet, that means any of the other VS specific
