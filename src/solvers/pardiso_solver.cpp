...
PardisoSolver::PardisoSolver(std::shared_ptr<ImplicitTimeStepper> stepper)
    ...
    iparm[12] = 0;  /* Maximum weighted matching algorithm is switched-on
    ...
    iparm[23] = 10; /* Two-level factorization for nonsymmetric matrices
                       iparm[10 & 12] must be 0 */
}
...
void PardisoSolver::integrator() {
    ...
    // mkl_sparse_d_create_csr ( &csrA, SPARSE_INDEX_BASE_ONE, n, n, ia, ia+1,
    // ja, a );
