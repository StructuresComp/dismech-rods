...
class magnumDERSimulationEnvironment : public Platform::Application,
                                       public derSimulationEnvironment
{
  public:
    explicit magnumDERSimulationEnvironment(const shared_ptr<world>& m_world,
                                            const renderParams& render_params,
                                            const shared_ptr<worldLogger>& logger, int argc,
                                            char** argv);
