...
magnumDERSimulationEnvironment::magnumDERSimulationEnvironment(
...
Vector3 magnumDERSimulationEnvironment::unproject(const Vector2i& windowPosition,
                                                  Float depth) const {
...
void magnumDERSimulationEnvironment::renderEdge(Eigen::Vector3d top_vertex,
                                                Eigen::Vector3d bot_vertex, float radius,
                                                Magnum::Color3 color) {
